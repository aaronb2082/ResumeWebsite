let quotes = [
 ...
 // document.onclick.getElementById("quotes").innerHTML = displayQuote;

 // document.body.onclick.getElementById("quotes").innerHTML = displayQuote;

 // addEventListener('onclick', displayQuote);

   //  let changeQuote = quotes[randomQuote];

 // document.getElementById("Btn").onclick = displayQuote;

 // document.getElementById("Btn").onclick = document.write("quotes");